...
def free_bacon(score):
    ...
    num_list = []
    for i in range(2):
        num_list.append(score%10)
        score = int(score/10)
    return 1 + max(num_list)
    # END PROBLEM 2
...
def both(f, g):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def exec_both(score0, score1):
        func0 = f(score0, score1)
        func1 = g(score0, score1)
        return both(func0, func1)
    return exec_both
    # END PROBLEM 6
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    "*** YOUR CODE HERE ***"
    def announce(*args):
        if args[who] - previous_score > previous_high:
            new_previous_high = args[who] - previous_score
            if new_previous_high == 1:
                print(str(new_previous_high),"point! That's the biggest gain yet for Player",who)
            else:
                print(str(new_previous_high),"points! That's the biggest gain yet for Player",who)
            return announce_highest(who, new_previous_high, args[who])
        return announce_highest(who, previous_high, args[who])
    return announce
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    avg_list = []
    for i in range(1, 11):
        avg_list.append(make_averaged(roll_dice, num_samples)(i, dice))
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    if is_swap(free_bacon(opponent_score) + score, opponent_score) and opponent_score - free_bacon(opponent_score) - score >= margin:
        return 0
